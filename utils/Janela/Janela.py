...
def func_Cor(valor):
    ...
    cor, imagem_cor, botao_icone_cor, imagem_idioma, botao_icone_idioma, imagem_doacao, botao_doacao = Cor.Atualizar_Cor(valor)
...
def Criar_Janela():
    global frame_botoes_roles, label_auto_aceitar, frame_botoes_idiomas, botoes_modos_de_jogo, botao_icone_idioma, frame_borda_topo, label_borda_topo, frame_borda_inferior, \
    ...
    frame_botoes_modos_de_jogo, botoes_modos_de_jogo = Botoes.ModoDeJogo.CriarBotoesModosDeJogo()
    ...
    botao_icone_idioma, lista_idiomas, frame_botoes_idiomas, botoes_idiomas = Idioma.CriarBotoesIdiomas(imagem_idioma)

    imagem_cor = ImageTk.PhotoImage(Cor.Alterar_Cor("Images/Color-change.png", "#000000", cor))
    botao_icone_cor, botoes_cores, frame_botao_cor_personalizada, botao_cor_personalizada = Cor.CriarBotoesCores(imagem_cor)
