    ...
    while True:
        ...
        try:
            ...
            image_path_image = os.path.join(
                "Images/languages",
                idioma,
                "Images" + f" {lol_window.width}x{lol_window.height}",
                image,
            )
            image_position_image = pyautogui.locateOnScreen(
                image_path_image, confidence=0.8
            )
    ...
    while True:
        ...
        try:
            ...
            image_path_Encontrar_partida = os.path.join(
                ...
                idioma,
                "Images" + f" {lol_window.width}x{lol_window.height}",
                "Encontrar partida.png",
            )
            image_position_Encontrar_partida = pyautogui.locateOnScreen(
                image_path_Encontrar_partida, confidence=0.8
            )
